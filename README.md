About voila-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/voila-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3656&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/voila-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `voila` can be installed with `conda`:
...
It is possible to list all of the versions of `voila` available on your platform with `conda`:
...
```
mamba search voila --channel conda-forge
```
...
mamba repoquery search voila --channel conda-forge

# List packages depending on `voila`:
mamba repoquery whoneeds voila --channel conda-forge

# List dependencies of `voila`:
mamba repoquery depends voila --channel conda-forge
```
